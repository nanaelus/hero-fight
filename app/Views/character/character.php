<div class="row">
    <div class="col">
        <form method="POST" action="<?= isset($character) ? base_url('character/updatecharacter') : base_url('character/createcharacter'); ?>" enctype="multipart/form-data">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <input type="hidden" name="user_id" value="<?= isset($character) ? $character['user_id'] : $userId; ?>">
